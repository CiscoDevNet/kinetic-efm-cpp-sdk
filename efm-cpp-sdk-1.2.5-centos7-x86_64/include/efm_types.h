...
#define ATTR_DEPRECATED _declspec(deprecated)
#elif defined(__APPLE__)
#define ATTR_DEPRECATED __AVAILABILITY_INTERNAL_DEPRECATED
#else
...
{
  /// The base path all redo logs will be stored in. Only the top folder of the full path will be created
  /// automatically.
  ...
  /// Controls if consistency issues of the redo log are being resolved automatically on start-up.
...
/// Options for the SSL client configuration
struct SSLOptions
{
