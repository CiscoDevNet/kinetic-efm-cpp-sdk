...
public:
  ...
  void set_close_handler(std::function<void(const NodePath& path, const std::error_code& ec)>&& close_handler);
  ...
  bool set_result(UniqueActionResultPtr action_result);

  /// Returns the type of this action result stream.
  /// @return The type of the stream.
  ActionResultType get_result_type() const;
  ...
  ActionStreamResult& get_result_stream();
  ...
  ActionTableResult& get_result_table();
